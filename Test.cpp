...
TEST_CASE("simple test") {   // abcd
    ...
    CHECK(board.read(100,202,Direction::Vertical, 1) == "d");
...
TEST_CASE("simple test with empty cell") {   
    ...
    CHECK(board.read(100,200,Direction::Vertical, 2) == "a_");
    CHECK(board.read(100,201,Direction::Vertical, 2) == "b_");
    CHECK(board.read(100,202,Direction::Vertical, 2) == "c_");
    CHECK(board.read(100,202,Direction::Vertical, 2) == "d_");

    CHECK_NOTHROW(board.post(100,200,Direction::Vertical, "abcd"));
    board.post(100,200,Direction::Vertical, "abcd");
    CHECK(board.read(99,200,Direction::Vertical, 6) == "_abcd_");
    CHECK(board.read(100,200,Direction::Horizontal, 2) == "a_");
